...
PRIMARY KEY(LISTAS_ID, CANCION_ID);

ALTER TABLE LISTA_CANCION ADD CONSTRAINT fk_listac_listar
FOREIGN KEY(LISTAS_ID) REFERENCES LISTA_REPRODUCCION(ID);

ALTER TABLE LISTA_CANCION ADD CONSTRAINT fk_listac_cancion
FOREIGN KEY(CANCION_ID) REFERENCES CANCION(ID);

-- INSERTAR USUARIO
INSERT INTO USUARIO VALUES('moios','Moi Avalos', 'moios@gmail.com','1234');
INSERT INTO USUARIO VALUES('pepe','Pedro Perez', 'pepe@gmail.com','1234');
